...
Commands:
  ...
  fetch         Fetch real Outlook messages using current EMAIL/HOURS_SINCE/LIMIT
...
Environment variables can still override them for one-off calls.
